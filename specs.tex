...
\begin{tabular}{lcc}
  ...
  % Robots & 28 -- 31 & 100 \\
  Tokens (gold) & 32 -- 42 & 100 \\
  Tokens (silver) & 43 -- 53 & 100 \\
  \bottomrule
\end{tabular}
\end{center}
...
\begin{enumerate}
  ...
  \item In the centre of the arena is a platform raised by \SI{178}{mm}
        ...
        circle of six tokens. No token will be placed with its outside edge
        more than \SI{150}{mm} from the edge of the platform.
\end{enumerate}
