...
\begin{enumerate}
  ...
  \item The central reservation is surrounded by walls, which are \SI{358}{mm}
        high.
  ...
  \item Within the short-cut there are fixed obstacles. These have a square
        cross-section, with the area touching the floor being a square with
        edges of length \SI{200}{mm}. Their height is deliberately left
        unspecified here. Their layout is given in Figure~\ref{fig:arena}.
