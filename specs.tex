...
\begin{enumerate}
  ...
  \item There are four non-directional radio beacons for localization, placed
        along the longer walls of the arena inset by \SI{3000}{mm}. These
        beacons have an operational range of \SI{4500}{mm}.
...
\begin{enumerate}
  ...
  \item Each container is fitted with a non-directional radio beacon
        which can be used to locate it. The beacon has an operational
        range of \SI{2000}{mm}.
\end{enumerate}
