...
\begin{enumerate}
  ...
  \item At the end of every lap -- defined as every sixth forward zone crossing --
        a robot is awarded an additional 4 points above the points it normally
        gets for the crossing.
