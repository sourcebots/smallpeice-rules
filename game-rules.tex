...
\begin{enumerate}
  ...
  \item A token is considered to be `in' a zone if either:
    \begin{enumerate}
      \item at least three corners of the token are in contact with the floor or surface
            of the raised area, or
      \item the projection of token onto the floor is entirely within the scoring zone
    \end{enumerate}
